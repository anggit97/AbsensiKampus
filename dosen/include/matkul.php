                  ...
                  <tbody> 
                        ...
                        ?>
                                <tr>
                                  ...
                                  <td><a href="index.php?page=9&&id_matkul=<?php echo $rows['id_matkul']; ?>" class="btn btn-primary" data-tt="tooltip" title="Klik Untuk Melakukan Absensi">Absensi Mahasiswa</a></td>
                                </tr>
