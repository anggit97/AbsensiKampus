<?php  
$query = mysqli_query($conn,"SELECT nm_dosen FROM dosen WHERE nid='$nid'");
if ($query) {
...
?>
          ...
          <h3>
            <b>Mata Kuliah Dosen "<?php echo $rows['nm_dosen']; ?>"</b>
          </h3>
          <ol class="breadcrumb">
    ...
    <a href="index.php?page=22" class="btn btn-primary btn-lg" style="margin-right:10px;float:right;"><i class="fa fa-reply"></i> Kembali</a>
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  ...
                  <table id="table" class="row-border" cellspacing="0" width="100%">
                    ...
                    $query = mysqli_query($conn,"SELECT a.*,b.nm_dosen FROM matkul a, dosen b WHERE  a.nid='$nid' AND a.nid=b.nid");
                    if ($query) {
                      $no = 1;
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a class="btn btn-success" href="index.php?page=24&&id_matkul=<?php echo $rows['id_matkul']; ?>&&nid=<?php echo $nid; ?>"><i class="fa fa-mouse-pointer"></i> Pilih Matkul</a></td>
                      </tr>
