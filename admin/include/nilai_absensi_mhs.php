          ...
          <h1>
            Nilai Absensi Mahasiswa
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#"><i class="fa fa-user"></i> Nilai Absensi Mahasiswa</a></li>
          </ol>
		...
		<p>Berikut ini adalah daftar Nilai Absensi Mahasiswa yang tercatat di database universitas : 
		</p>
		<br>
        ...
        <table id="dosen" class="row-border" cellspacing="0" width="100%">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="index.php?page=17&&nim=<?php echo $rows['nim']; ?>" class="btn btn-success"><i class="fa fa-mouse-pointer"></i> Pilih Matkul</a></td>
                    </tr>
