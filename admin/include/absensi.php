		...
		<p>Berikut ini adalah daftar absensi matakuliah yang terdaftar di database Universitas:
		</p>
		<br>
                  ...
                  <table id="table" class="row-border" cellspacing="0" width="100%">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="index.php?page=14&&id_matkul=<?php echo $rows['id_matkul']; ?>" class="btn btn-primary">Daftar Mahasiswa</a></td>
                      </tr>
