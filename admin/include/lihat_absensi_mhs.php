...
$query2 = mysqli_query($conn,"SELECT * FROM mahasiswa WHERE nim='$nim'");
if ($query2) {
...
?>
        ...
        <a href="index.php?page=17&&nim=<?php echo $nim; ?>" class="btn btn-primary btn-lg" style="margin-right:10px;float:right;"><i class="fa fa-reply"></i> Kembali</a>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <table class="table table-bordered table-hover table-striped" style="width:45%;float:right;margin-right:30px;">
            <tr>
                <td>Nama</td>
                <td>: <b><?php echo $rows_m['nm_mhs']; ?></b></td>
            </tr>
            <tr>
                <td>Telp</td>
                <td>: <?php echo $rows_m['telp_mhs']; ?></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>: <?php echo $rows_m['alamat_mhs']; ?></td>
            </tr>
        </table>
...
<div class="box">
    ...
    <div class="box-body">
        <table id="dosen" class="row-border" cellspacing="0" width="100%">
                ...
                $num2  = 0;
                $x     = 0;
                $query = mysqli_query($conn,"SELECT * FROM absen_kelas WHERE nim='$nim' AND id_matkul='$id_matkul' ORDER BY pertemuan");
                if ($query) {
                    $no = 1;
