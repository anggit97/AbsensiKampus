          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-user"></i> Absensi Dosen</a></li>
          </ol>
        ...
        <table id="dosen" class="row-border" cellspacing="0" width="100%">
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="btn btn-success" href="index.php?page=23&&nid=<?php echo $rows['nid']; ?>"><i class="fa fa-pencil"></i> Absen Dosen</a></td>
                    </tr>
                <?php
                    }
                }
